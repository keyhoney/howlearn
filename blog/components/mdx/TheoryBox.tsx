...
export function TheoryBox({
  ...
  return (
    <aside
      ...
      aria-label="이론"
    >
      <p className="text-xs font-semibold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">이론</p>
      ...
      {whyItMatters && (
        <p className="mt-3 text-sm font-medium text-slate-500 dark:text-slate-400">
          <span className="text-slate-900 dark:text-slate-100">왜 중요한가: </span>
          {whyItMatters}
        </p>
      )}
