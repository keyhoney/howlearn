...
export function KeyTakeaways({ items }: KeyTakeawaysProps) {
  ...
  return (
    <aside
      className="my-8 rounded-xl border-2 border-indigo-200 bg-indigo-50/50 p-5 md:p-6"
      aria-label="Key takeaways"
    >
      <p className="text-xs font-semibold uppercase tracking-wider text-indigo-600">Key takeaways</p>
